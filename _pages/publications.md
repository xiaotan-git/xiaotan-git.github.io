...
## Journal Papers
1. Shima Sadat Mousavi, **Xiao Tan**, Aaron D. Ames, **From Vertices to Convex Hulls: Certifying Set-Wise Compatibility for CBF Constraints**, IEEE Control Systems Letters, 2026. [Paper](https://ieeexplore.ieee.org/document/11315123)
1. C. Liu, **X. Tan**, X. Wu, D. V. Dimarogonas, and K. H. Johansson, **Achieving violation-free distributed optimization under coupling constraints**, Automatica, 2026. [Paper](https://arxiv.org/pdf/2404.07609)
1. **X. Tan**, C. Liu, K. H. Johansson, and D. V. Dimarogonas, **A continuous-time violation-free multi-agent optimization algorithm and its applications to safe distributed control**, IEEE Transactions on Automatic Control, to appear, 2025. [Paper](https://arxiv.org/abs/2404.07571)
...
## Conference Papers
1. **Xiao Tan**, Pio Ong, Paulo Tabuada, Aaron D. Ames, **Secure Safety Filter Design for Sampled-data Nonlinear Systems under Sensor Spoofing Attacks**. 64th IEEE Conference on Decision and Control (CDC), December 2025. [Paper](https://arxiv.org/abs/2505.06842)
1. **Xiao Tan**, Junior Sundar, Renzo Bruzzone, Pio Ong, Willian T. Lunardi, Martin Andreoni, Paulo Tabuada, and Aaron D. Ames, **Secure Safety Filter: Towards Safe Flight Control under Sensor Attack**, the 2025 IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS). [Paper](https://arxiv.org/abs/2505.06845)
